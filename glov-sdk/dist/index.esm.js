...
var pushToGlovInfoLayer = function pushToGlovInfoLayer(key, value) {
  ...
  if (Array.isArray(infoLayer)) {
    infoLayer.push(_defineProperty({}, key.split(".")[1], value));
    return;
  }
...
var checkDataLayerRule = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee(rule) {
...
var RuleEngine = /*#__PURE__*/function () {
  ...
  _createClass(RuleEngine, [{
    key: "checkRules",
    value: function () {
      var _checkRules = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee() {
    ...
    key: "checkRule",
    value: function () {
      var _checkRule = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee2(rule) {
    ...
    value: function () {
      var _checkEligibilityRules = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee3() {
